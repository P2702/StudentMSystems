  ...
  <head>
   ...
   <script>
   	function modify(trno)   // trno=101
   	{
   		...
   		var td = tr.getElementsByTagName("td"); // <tr> <td-0> <td-1> <td-2> </tr
   		
   		trno      = td[0].textContent;
   		var tname = td[1].querySelector("input").value;  //name="AAA"
		var tper  = td[2].querySelector("input").value;  // per= 88
   		...
   		.then(data => 
   					{
   						...
   						if(data.trim()=="failed")
   						{
   							alert("Failed to Updated Record for Roll Number : " + trno);
   						}
   			     	})
